...
: ${AMENT_CURRENT_PREFIX:="/workspace/referee_serial/install/referee-serial"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/referee-serial/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/referee-serial/environment/path.sh"
